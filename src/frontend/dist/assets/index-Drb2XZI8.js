...
function groupedMixNuts(colors, nutsPerTube, emptyTubes, rand, mixFraction = 0.35) {
  const numColors = colors.length;
  const pools = colors.map((c) => Array(nutsPerTube).fill(c));
  const tubes = [];
  for (let t = 0; t < numColors; t++) {
    const primaryColor = colors[t];
    const tube = Array(nutsPerTube).fill(primaryColor);
...
function generateLevel(levelNum) {
  ...
  if (levelNum <= 400) {
    ...
    const rand2 = mulberry32(baseSeed + 9 * 1234567);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        transition,
        animation,
        filter: isSelected || isFloating || isUnscrewing ? `drop-shadow(0 10px 20px ${info.bg}ee) drop-shadow(0 0 14px ${info.bg}bb)` : `drop-shadow(0 8px 14px ${info.shadow}cc) drop-shadow(0 3px 6px rgba(0,0,0,0.75))`,
        ...style2
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              inset: 0,
              clipPath: hexClip,
              background: "linear-gradient(148deg, rgba(255,255,255,0.72) 0%, rgba(255,255,255,0.22) 22%, transparent 48%, rgba(0,0,0,0.28) 80%, rgba(0,0,0,0.52) 100%)",
              pointerEvents: "none"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              inset: 0,
              clipPath: hexClip,
              background: "linear-gradient(270deg, rgba(255,255,255,0.20) 0%, transparent 30%)",
              pointerEvents: "none"
            }
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              boxShadow: "inset 0 4px 8px rgba(255,255,255,0.5), inset 0 -4px 8px rgba(0,0,0,0.7), 0 2px 6px rgba(0,0,0,0.6), 0 0 0 2.5px rgba(0,0,0,0.35)",
              zIndex: 2
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              transform: "translate(-50%, -50%)",
              borderRadius: "50%",
              background: "radial-gradient(circle at 33% 28%, #252525, #050505 55%, #000)",
              boxShadow: "inset 0 5px 12px rgba(0,0,0,0.99), inset 0 -1px 4px rgba(255,255,255,0.05), 0 0 0 3.5px rgba(0,0,0,0.85)",
              zIndex: 3
            }
          }
        ),
...
const Tube = ({
  ...
  const rodGradient = "linear-gradient(to right, #1a1a1a 0%, #444 6%, #7a7a7a 18%, #b8b8b8 32%, #d8d8d8 42%, #e8e8e8 50%, #d8d8d8 58%, #b8b8b8 68%, #7a7a7a 82%, #444 94%, #1a1a1a 100%)";
  const baseGradient = "linear-gradient(to bottom, #d8e0e8 0%, #eef2f6 15%, #ccd4dc 40%, #8896a8 70%, #4a5668 100%)";
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: isSelected && nuts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
              NutPiece,
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            onClick,
            "aria-label": `Bolt stand with ${nuts.length} nut${nuts.length !== 1 ? "s" : ""}`,
            style: {
              background: "none",
              border: "none",
              padding: 0,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    width: rodWidth + 6,
                    height: 12,
                    background: "linear-gradient(to bottom, #ddd 0%, #999 50%, #666 100%)",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        style: {
                          ...
                          border: rodBorder,
                          boxShadow: isSelected || isHintFrom || isHintTo ? rodGlow : "0 4px 12px rgba(0,0,0,0.7), 2px 0 6px rgba(0,0,0,0.4)",
                          borderRadius: 6,
                          zIndex: 1,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: stackedNuts.map((nutColor, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          NutPiece,
                          {
                            color: nutColor,
                            size: nutSize,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    ...
                    borderRadius: "50%",
                    boxShadow: "0 14px 32px rgba(0,0,0,0.85), 0 6px 14px rgba(0,0,0,0.65), inset 0 5px 0 rgba(255,255,255,0.55), inset 0 -5px 0 rgba(0,0,0,0.5)",
                    marginTop: -2,
                    zIndex: 2,
                    flexShrink: 0,
                    position: "relative",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          ...
                          right: "15%",
                          height: "45%",
                          background: "linear-gradient(to bottom, rgba(255,255,255,0.6), rgba(255,255,255,0.08))",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          ...
                          height: 8,
                          borderRadius: "50%",
                          background: "radial-gradient(circle at 35% 30%, #d8dfe8, #5a6070)",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Sort the nuts. Master the puzzle."
                }
              )
            ]
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  style: {
                    ...
                    margin: "0 0 4px",
                    fontFamily: "Fredoka One, Nunito, sans-serif",
                    textShadow: "-2px -2px 0 rgba(255,180,0,0.5), 2px -2px 0 rgba(255,180,0,0.5), -2px 2px 0 rgba(255,180,0,0.5), 2px 2px 0 rgba(255,180,0,0.5)",
                    letterSpacing: "1px"
                  },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: 16 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(StarRating, { stars, size: "lg", animate: true }) }),
...
const App = () => {
  ...
  const [screen, setScreen] = reactExports.useState({ type: "home" });
