...
function groupedMixNuts(colors, nutsPerTube, emptyTubes, rand, mixFraction = 0.3) {
  const numColors = colors.length;
  const tubes = Array.from(
    { length: numColors },
    (_, t) => Array(nutsPerTube).fill(colors[t])
  );
...
function countMinMoves(tubes, nutsPerTube) {
  if (isLevelComplete(tubes, nutsPerTube)) return 0;
  const queue = [{ tubes: tubes.map((t) => [...t]), depth: 0 }];
  ...
  while (queue.length > 0) {
    ...
    for (let from = 0; from < cur.tubes.length; from++) {
      ...
      for (let to = 0; to < cur.tubes.length; to++) {
        ...
        if (cur.tubes[to].length > 0 && cur.tubes[to][cur.tubes[to].length - 1] !== nut)
          continue;
...
function generateLevel(levelNum) {
  ...
  const selectedColors = NUT_COLORS.slice(0, colors);
  const mixFraction = Math.min(0.5, 0.3 + levelNum * 1e-3);
...
function createGameState(levelNum, tubes, isDaily = false) {
  return {
    levelNum,
    tubes: tubes.map((t) => [...t]),
    selectedTube: null,
...
function isLevelComplete(tubes, nutsPerTube) {
  for (const tube of tubes) {
...
function canPickFrom(tubes, tubeIdx) {
  return tubes[tubeIdx].length > 0;
}
function canPlaceOn(tubes, tubeIdx, nut, nutsPerTube) {
  const tube = tubes[tubeIdx];
  if (tube.length >= nutsPerTube) return false;
  if (tube.length === 0) return true;
  return tube[tube.length - 1] === nut;
}
function getValidMoves(tubes, nutsPerTube) {
  const moves = [];
...
class SoundSystem {
  constructor() {
    ...
    __publicField(this, "soundEnabled", true);
    __publicField(this, "musicEnabled", true);
    __publicField(this, "musicOscillators", []);
  ...
  playTone(freq, duration, type = "sine", gain = 0.3, delay = 0) {
  ...
  stopBgMusic() {
    ...
    if (this.musicGain) {
      try {
        this.musicGain.gain.setValueAtTime(0, ((_a2 = this.ctx) == null ? void 0 : _a2.currentTime) ?? 0);
...
function getDefaultSave() {
  return {
    ...
    activeBackground: "linear-gradient(180deg, #87CEEB 0%, #B0E0FF 40%, #E8F4FF 100%)",
    premiumUntil: null
  };
}
function loadSave() {
...
function completeLevelInSave(save, levelNum, stars, moveCount) {
  const existing = save.levelProgress[levelNum];
  const betterStars = existing ? Math.max(existing.stars, stars) : stars;
  const betterMoves = existing ? Math.min(existing.bestMoves, moveCount) : moveCount;
  ...
  return {
    ...
    maxUnlockedLevel: Math.min(newMaxUnlocked, 5e3),
    levelProgress: {
      ...save.levelProgress,
...
function claimDailyChallenge(save) {
  const today = (/* @__PURE__ */ new Date()).toISOString().split("T")[0];
  if (save.lastDailyChallenge === today) return save;
  const yesterday = /* @__PURE__ */ new Date();
  yesterday.setDate(yesterday.getDate() - 1);
  const yesterdayStr = yesterday.toISOString().split("T")[0];
  const streak = save.lastDailyChallenge === yesterdayStr ? save.dailyChallengeStreak + 1 : 1;
  return {
    ...save,
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 28 }, children: soundEnabled ? "🔊" : "🔇" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            style: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 28 }, children: musicEnabled ? "🎵" : "🎵" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            style: {
                            ...
                            children: musicEnabled ? "Music On" : "Music Off"
                          }
                        )
                      ]
                    }
...
const NutPiece = ({
  ...
  const hexClip = "polygon(15% 0%, 85% 0%, 100% 50%, 85% 100%, 15% 100%, 0% 50%)";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        transition,
        animation,
        filter: isSelected || isFloating || isUnscrewing || isComplete ? `drop-shadow(0 6px 14px ${info.bg}ee) drop-shadow(0 0 10px ${info.bg}bb)` : `drop-shadow(0 4px 8px ${info.shadow}cc) drop-shadow(0 2px 4px rgba(0,0,0,0.75))`,
        ...style2
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              inset: 0,
              clipPath: hexClip,
              background: "linear-gradient(to bottom, rgba(255,255,255,0.75) 0%, rgba(255,255,255,0.18) 35%, transparent 55%, rgba(0,0,0,0.30) 80%, rgba(0,0,0,0.55) 100%)",
              pointerEvents: "none"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              inset: 0,
              clipPath: hexClip,
              background: "linear-gradient(to right, rgba(255,255,255,0.22) 0%, transparent 25%)",
              pointerEvents: "none"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              inset: 0,
              clipPath: hexClip,
              background: "linear-gradient(to left, rgba(0,0,0,0.30) 0%, transparent 25%)",
              pointerEvents: "none"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              borderRadius: "50%",
              background: "radial-gradient(ellipse at 35% 30%, #282828, #080808 60%, #000)",
              boxShadow: "inset 0 3px 8px rgba(0,0,0,0.99), inset 0 -1px 3px rgba(255,255,255,0.04), 0 0 0 2.5px rgba(0,0,0,0.80)",
              zIndex: 3
            }
          }
        ),
        ...
        (isSelected || isFloating) && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
...
const Tube = ({
  ...
  const completedColor = isComplete && nuts.length > 0 ? ((_a2 = COLOR_MAP[nuts[0]]) == null ? void 0 : _a2.bg) ?? "#FFD700" : null;
  let rodGlow = "none";
  let hintAnimation;
  if (isComplete) {
  ...
  const rodGradient = "linear-gradient(to right, #111 0%, #444 12%, #888 25%, #ccc 40%, #efefef 50%, #ccc 60%, #888 75%, #444 88%, #111 100%)";
  ...
  const getNutTop = (index2) => {
    const bottomY = rodHeight - 24 - nutH;
    return bottomY - index2 * (nutH + nutSpacing);
  };
  const baseGradient = "linear-gradient(to bottom, #d0d8e4 0%, #eef2f8 18%, #c0c8d4 42%, #7880a0 72%, #3a4060 100%)";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        cursor: "pointer",
        width: totalWidth,
        animation: isInvalid ? "tube-shake 0.4s ease" : isComplete ? hintAnimation : hintAnimation,
        paddingTop: nutH + 20,
        position: "relative"
      },
      "data-ocid": "game.tube",
      children: [
        isComplete && completedColor && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
        ...
        isComplete && completedColor && [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              floatingNut && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    position: "absolute",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        style: {
                          ...
                          height: "100%",
                          zIndex: 1,
                          boxShadow: isComplete ? rodGlow : isSelected || isHintFrom || isHintTo ? rodGlow : "2px 0 6px rgba(0,0,0,0.5), -1px 0 4px rgba(0,0,0,0.3)",
                        ...
                        children: [
                          ...
                          Array.from({ length: threadCount }, (_, ti) => ti).map((ti) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              style: {
                                position: "absolute",
                                ...
                                height: threadHeight,
                                background: "linear-gradient(to bottom, rgba(0,0,0,0.25) 0%, rgba(255,255,255,0.08) 50%, rgba(0,0,0,0.2) 100%)",
                                pointerEvents: "none"
                              }
                            },
                            `thread-slot-${ti}`
                          )),
                          innerColor && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              style: {
                                position: "absolute",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              style: {
                                ...
                                right: -2,
                                height: 8,
                                background: "linear-gradient(to bottom, #f0f0f0 0%, #999 60%, #666 100%)",
                    ...
                    stackedNuts.map((nutColor, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          position: "absolute",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    width: baseWidth,
                    height: baseHeight,
                    background: isComplete && completedColor ? `linear-gradient(to bottom, ${completedColor}88 0%, ${completedColor}44 40%, #7880a0 72%, #3a4060 100%)` : baseGradient,
                    borderRadius: "50%",
                    boxShadow: isComplete && completedColor ? `0 10px 24px rgba(0,0,0,0.8), 0 4px 10px rgba(0,0,0,0.6), inset 0 3px 0 rgba(255,255,255,0.5), inset 0 -3px 0 rgba(0,0,0,0.45), 0 0 20px ${completedColor}99` : "0 10px 24px rgba(0,0,0,0.8), 0 4px 10px rgba(0,0,0,0.6), inset 0 3px 0 rgba(255,255,255,0.5), inset 0 -3px 0 rgba(0,0,0,0.45)",
                    marginTop: -2,
                    zIndex: 2,
                    flexShrink: 0,
                    position: "relative",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          ...
                          height: 6,
                          borderRadius: "50%",
                          background: "radial-gradient(circle at 35% 30%, #d0d8e4, #505870)",
...
const GameScreen = ({
  ...
  const initTubes = reactExports.useMemo(() => {
  ...
  const [invalidTube, setInvalidTube] = reactExports.useState(null);
  const [extraStandUsed, setExtraStandUsed] = reactExports.useState(false);
  const [unscrewingTube, setUnscrewingTube] = reactExports.useState(null);
  const [screwingInTube, setScrewingInTube] = reactExports.useState(null);
  const config = reactExports.useMemo(() => getLevelConfig(levelNum), [levelNum]);
  ...
  const handleTubeClick = reactExports.useCallback(
    (tubeIdx) => {
      ...
      if (newState.selectedTube === gameState.selectedTube && newState.moveCount === gameState.moveCount && prevSelected !== null && prevSelected !== tubeIdx) {
  ...
  const handleAddStand = reactExports.useCallback(() => {
  ...
  const tubeIds = reactExports.useMemo(
    () => Array.from(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        minHeight: "100dvh",
        background: activeBackground || "linear-gradient(180deg, #87CEEB 0%, #B0E0FF 40%, #E8F4FF 100%)",
        display: "flex",
        flexDirection: "column",
        fontFamily: "Nunito, sans-serif",
        overflow: "hidden",
      ...
      "data-ocid": "game.page",
      children: [
        GAME_CLOUDS.map((cloud) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    ...
                    padding: "6px 20px",
                    textAlign: "center",
                    boxShadow: "0 4px 0 rgba(0,0,0,0.2), 0 6px 12px rgba(255,180,0,0.3)"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: isDaily ? "🌟 Daily" : `Level ${levelNum}`
                      }
                    ),
                    !isDaily && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          fontSize: 10,
                        ...
                        children: getChapterName(chapter)
                      }
                    )
                  ]
                }
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          children: save.totalPoints.toLocaleString()
                        }
                      )
                    ]
                  }
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: gameState.tubes.map((tube, i) => {
                  var _a2, _b2;
                  return /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Tube,
                    {
                      ...
                      isHintFrom: ((_a2 = gameState.hintHighlight) == null ? void 0 : _a2.from) === i,
                      isHintTo: ((_b2 = gameState.hintHighlight) == null ? void 0 : _b2.to) === i,
                      isInvalid: invalidTube === i,
                      isUnscrewing: unscrewingTube === i,
                      isScrewingIn: screwingInTube === i,
                      isComplete: tube.length === nutsPerTube && tube.length > 0 && tube.every((n) => n === tube[0]),
                      innerColor: ROD_INNER_COLORS[i % ROD_INNER_COLORS.length],
                      onClick: () => handleTubeClick(i),
                      nutSize
                    },
                    tubeIds[i] ?? `tube-new-${i}`
                  );
                })
              }
            )
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  onClick: handleUndo,
                  disabled: gameState.undosLeft === 0 || gameState.undoStack.length === 0,
                  "data-ocid": "game.undo_button",
                  title: "Undo",
                  children: [
                    "↩",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { marginLeft: 4, fontSize: 13 }, children: "Undo" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hud-btn-badge", children: gameState.undosLeft })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    "💡",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { marginLeft: 4, fontSize: 13 }, children: "Hint" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hud-btn-badge", children: gameState.hintsLeft })
                  ]
                }
              ),
              !isDaily && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  ...
                  children: [
                    "➕",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { marginLeft: 4, fontSize: 13 }, children: extraStandUsed ? "Stand" : "Stand (free)" })
                  ]
                }
              )
            ]
...
const HomeScreen = ({
  ...
  const starStyles = reactExports.useMemo(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        minHeight: "100dvh",
        background: "linear-gradient(160deg, #FF9A9E 0%, #FAD0C4 25%, #A8EDEA 65%, #FED6E3 100%)",
        display: "flex",
        flexDirection: "column",
        alignItems: "center",
        justifyContent: "center",
      ...
      "data-ocid": "home.page",
      children: [
        CLOUDS.map((cloud) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
        ...
        STAR_PARTICLES.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: LOGO_DOTS.map((dot) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        width: 18,
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
                        ...
                        display: "inline",
                        textShadow: "none",
                        filter: "drop-shadow(-3px -3px 0 rgba(0,0,0,0.55)) drop-shadow(3px -3px 0 rgba(0,0,0,0.55)) drop-shadow(-3px 3px 0 rgba(0,0,0,0.55)) drop-shadow(3px 3px 0 rgba(0,0,0,0.55)) drop-shadow(0 6px 0 rgba(0,0,0,0.25))"
                      },
                      children: "SortCraft"
                    }
                  )
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  style: {
                    ...
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text",
                    filter: "drop-shadow(-2px -2px 0 rgba(0,0,0,0.5)) drop-shadow(2px -2px 0 rgba(0,0,0,0.5)) drop-shadow(-2px 2px 0 rgba(0,0,0,0.5)) drop-shadow(2px 2px 0 rgba(0,0,0,0.5))"
                  },
                  children: "Puzzle"
                }
              ),
                ...
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      children: "🎮 Developed by Adarsh Chaudhary"
                    }
                  )
                }
              )
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                ...
                style: {
                  ...
                  maxWidth: "52vw",
                  objectFit: "contain",
                  filter: "drop-shadow(0 8px 24px rgba(200,80,255,0.3)) drop-shadow(0 4px 8px rgba(0,0,0,0.3))"
                }
              }
            )
          }
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🌟 Daily Challenge" }),
                    save.dailyChallengeStreak > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                        style: {
                          position: "absolute",
                    ...
                    hasDailyToday && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        style: {
                          position: "absolute",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              "Level ",
              save.maxUnlockedLevel > 1 ? save.maxUnlockedLevel - 1 : 1,
              " ",
              "reached  · ",
              Object.keys(save.levelProgress).length,
              " completed"
            ]
          }
        ),
...
const Confetti = ({ active }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "confetti-container", "aria-hidden": "true", children: PARTICLE_DATA.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
...
const StarRating = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 items-center justify-center", children: [1, 2, 3].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "span",
    {
      className: `${sizeClass} transition-all duration-300 ${animate ? "star-pop" : ""}`,
      style: {
        animationDelay: animate ? `${(s - 1) * 0.3}s` : void 0,
...
const LevelCompleteScreen = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Confetti, { active: visible }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              background: "linear-gradient(135deg, #FFF9E6 0%, #FFF0A0 50%, #FFE066 100%)",
              border: "4px solid rgba(0,0,0,0.2)",
              borderRadius: 28,
              padding: "28px 24px 24px",
              width: "min(320px, 82vw)",
              textAlign: "center",
              boxShadow: "0 8px 0 rgba(0,0,0,0.2), 0 16px 40px rgba(0,0,0,0.4), 0 0 60px rgba(255,200,0,0.3)",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    lineHeight: 1,
                    marginBottom: 8,
                    background: "linear-gradient(135deg, #FF4FD8 0%, #FF8C00 50%, #FFD700 100%)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text",
                    filter: "drop-shadow(-2px -2px 0 rgba(0,0,0,0.35)) drop-shadow(2px -2px 0 rgba(0,0,0,0.35)) drop-shadow(-2px 2px 0 rgba(0,0,0,0.35)) drop-shadow(2px 2px 0 rgba(0,0,0,0.35)) drop-shadow(0 5px 0 rgba(0,0,0,0.2))",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  ...
                  children: [
                    isDaily ? "Daily Challenge" : `Level ${levelNum}`,
                    " · ",
                    moves,
                    " moves"
                  ]
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: 12 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(StarRating, { stars, size: "lg", animate: true }) }),
              showPoints && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    background: "linear-gradient(135deg, #FF6B9D 0%, #FF8E53 100%)",
                    ...
                    boxShadow: "0 5px 0 rgba(0,0,0,0.2), 0 8px 20px rgba(255,100,120,0.35)"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "You've run out of valid moves. Don't worry — every master was once a beginner! Try a different approach."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              hintsLeft > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
...
function getChapterStyle(chapterNum) {
  return CHAPTER_COLORS[chapterNum % 10 || 10];
}
const TOTAL_LEVELS = 5e3;
const LevelSelectScreen = ({
  save,
  onSelectLevel,
  onBack
}) => {
  const handleLevelClick = reactExports.useCallback(
    (levelNum) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
                  style: {
                    ...
                    flex: 1,
                    fontFamily: "Fredoka One, Nunito, sans-serif",
                    textShadow: "-2px -2px 0 rgba(0,0,0,0.3), 2px -2px 0 rgba(0,0,0,0.3), -2px 2px 0 rgba(0,0,0,0.3), 2px 2px 0 rgba(0,0,0,0.3)"
                  },
                  children: "🗺 Level Map"
                }
              ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, overflowY: "auto", padding: "16px 12px 40px" }, children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: getChapterName(chapterNum)
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: Array.from(
                    ...
                    const stars = (progress == null ? void 0 : progress.stars) ?? 0;
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        style: {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              ...
                              style: {
                                ...
                                height: 56,
                                borderRadius: 16,
                                border: isCurrent ? "3px solid #FFD700" : "3px solid rgba(0,0,0,0.22)",
                                background: isLocked ? "rgba(200,200,220,0.4)" : isCompleted ? "linear-gradient(135deg, #6ee86f 0%, #1d9e26 100%)" : isCurrent ? "linear-gradient(135deg, #FFE566 0%, #FF9900 100%)" : chapterStyle.bg,
                                color: isLocked ? "rgba(255,255,255,0.4)" : isCompleted ? "#0a3d0d" : isCurrent ? "#5a2800" : chapterStyle.text,
                                fontWeight: 900,
                                fontSize: 15,
                                ...
                                alignItems: "center",
                                justifyContent: "center",
                                boxShadow: isLocked ? "0 3px 0 rgba(0,0,0,0.1)" : isCurrent ? "0 4px 0 #b85e00, 0 0 16px rgba(255,215,0,0.55), 0 6px 14px rgba(0,0,0,0.25)" : isCompleted ? "0 4px 0 #157019, 0 6px 12px rgba(0,0,0,0.2)" : `0 4px 0 ${chapterStyle.shadow}, 0 6px 12px rgba(0,0,0,0.2)`,
                                transition: "transform 0.15s ease, box-shadow 0.15s ease",
                                fontFamily: "Fredoka One, Nunito, sans-serif",
                                animation: isCurrent ? "cartoon-bounce 2s ease-in-out infinite" : "none"
                              },
                              children: isLocked ? "🔒" : isCompleted ? "✓" : levelNum
                            }
                          ),
                          isCompleted ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 1 }, children: [1, 2, 3].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              style: {
                                fontSize: 9,
                                opacity: s <= stars ? 1 : 0.25,
                                filter: s <= stars ? "drop-shadow(0 0 3px #FFD700)" : "none"
                              },
                              children: "⭐"
                            },
                            `star-${levelNum}-${s}`
          ...
          save.maxUnlockedLevel < TOTAL_LEVELS && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                textAlign: "center",
...
const STAR_POSITIONS = [
  ...
  { id: "s10", left: "81%", top: "80%", size: 22, delay: 1 },
...
function LoadingScreen({ onComplete }) {
  ...
  const [msgIndex] = reactExports.useState(
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: STAR_POSITIONS.map((star, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  position: "absolute",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              background: "linear-gradient(135deg, #FF6B35 0%, #F7C59F 30%, #FFD700 60%, #FF6B9D 100%)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
              backgroundClip: "text",
              textShadow: "none",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    ...
                    boxShadow: "0 4px 16px rgba(255,107,53,0.2), inset 0 2px 6px rgba(0,0,0,0.08)",
                    overflow: "hidden",
                    position: "relative"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          height: "100%",
                          width: `${progress}%`,
                          background: "linear-gradient(90deg, #FFD700 0%, #FF9A00 35%, #FF6B35 70%, #FF6B9D 100%)",
                          borderRadius: "999px",
                          boxShadow: "0 0 14px rgba(255,107,53,0.6), inset 0 2px 6px rgba(255,255,255,0.4)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: loadingMessages[msgIndex]
                }
              )
            ]
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: NUT_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                style: {
                  display: "inline-block",
...
const VIP_BACKGROUNDS = [
  {
    id: "galaxy",
    name: "Galaxy",
    gradient: "linear-gradient(135deg, #0D0221 0%, #240046 25%, #3C096C 50%, #5A189A 75%, #7B2FBE 100%)"
  },
  {
    id: "neon_city",
    name: "Neon City",
    gradient: "linear-gradient(135deg, #0A0A0A 0%, #1A0A2E 30%, #16003E 60%, #0A0A0A 100%)"
  },
  {
    id: "dragon_fire",
    name: "Dragon Fire",
    gradient: "linear-gradient(135deg, #1A0000 0%, #8B0000 30%, #DC143C 60%, #FF4500 85%, #FFD700 100%)"
  },
  {
    id: "deep_sea",
    name: "Deep Sea",
    gradient: "linear-gradient(135deg, #000428 0%, #004e92 50%, #00B4D8 75%, #90E0EF 100%)"
  },
  {
    id: "aurora_borealis",
    name: "Aurora Borealis",
    gradient: "linear-gradient(135deg, #001F0D 0%, #004D25 20%, #00B300 40%, #00CED1 60%, #4169E1 80%, #8A2BE2 100%)"
  },
  {
    id: "volcano",
    name: "Volcano",
    gradient: "linear-gradient(135deg, #0D0000 0%, #3D0000 25%, #8B1A1A 50%, #CC3300 75%, #FF6600 100%)"
  },
  {
    id: "cosmic_dream",
    name: "Cosmic Dream",
  ...
  },
  {
    id: "emerald_palace",
    name: "Emerald Palace",
    gradient: "linear-gradient(135deg, #001A0D 0%, #003D1C 25%, #006633 50%, #00994D 75%, #00CC66 100%)"
  },
  {
    id: "ruby_throne",
    name: "Ruby Throne",
    gradient: "linear-gradient(135deg, #1A0010 0%, #4A0020 25%, #8B0040 50%, #CC0060 75%, #FF0080 100%)"
  },
  {
    id: "golden_empire",
    name: "Golden Empire",
    gradient: "linear-gradient(135deg, #1A0F00 0%, #4A2800 25%, #8B5000 50%, #CC8000 75%, #FFB800 100%)"
  }
];
...
const AdModal = ({ bgId: _bgId, bgName, onClose }) => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  height: 120,
                  borderRadius: 12,
                  background: "linear-gradient(135deg, #FF6B35 0%, #FF8E53 30%, #FFD700 60%, #FF6BC1 100%)",
                  marginBottom: 16,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
...
const DemoModal = ({ title, message, onClose }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "div",
  {
    style: {
      position: "fixed",
...
const ShopScreen = ({
  ...
  const [demoModal, setDemoModal] = reactExports.useState(null);
  const [adModal, setAdModal] = reactExports.useState(null);
  const [adCounts, setAdCounts] = reactExports.useState(
    () => loadAdCounts()
  );
  const isPremiumActive = save.premiumUntil !== null && save.premiumUntil > Date.now();
  const handleBuyPremium = reactExports.useCallback((planId) => {
    var _a2;
    soundSystem.playClick();
    setDemoModal({
...
Your plan: ${((_a2 = PREMIUM_PLANS.find((p) => p.id === planId)) == null ? void 0 : _a2.label) ?? planId}`
    });
  }, []);
  const handleSelectBackground = reactExports.useCallback(
    (_bgId, gradient) => {
      soundSystem.playClick();
      const updated = {
        ...save,
  ...
  const handleWatchAd = reactExports.useCallback((bgId, bgName) => {
    soundSystem.playClick();
    setAdModal({ bgId, bgName });
  }, []);
  const handleAdClose = reactExports.useCallback(
    (bgId, watched) => {
      setAdModal(null);
      if (!watched) return;
      ...
      if (newCounts[bgId] >= adsRequired) {
        const bg = NORMAL_BACKGROUNDS.find((b) => b.id === bgId) ?? VIP_BACKGROUNDS.find((b) => b.id === bgId);
        if (!bg) return;
        const alreadyUnlocked = save.unlockedBackgrounds.includes(bgId);
        const updated = {
          ...save,
          unlockedBackgrounds: alreadyUnlocked ? save.unlockedBackgrounds : [...save.unlockedBackgrounds, bgId],
  ...
  const handleBuyVipBg = reactExports.useCallback((bgName) => {
    soundSystem.playClick();
    setDemoModal({
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ["premium", "backgrounds"].map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => {
                ...
                style: {
                  flex: 1,
                  padding: "14px 8px",
                  background: activeTab === tab ? "rgba(255,107,157,0.25)" : "transparent",
                  border: "none",
                  borderBottom: activeTab === tab ? "3px solid #FF6B9D" : "3px solid transparent",
                ...
                children: tab === "premium" ? "👑 Remove Ads" : "🎨 Backgrounds"
              },
              tab
            ))
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              activeTab === "premium" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                PremiumTab,
                {
                  isPremiumActive,
              ...
              activeTab === "backgrounds" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                BackgroundsTab,
                {
                  save,
                  adCounts,
        ...
        demoModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
          DemoModal,
          {
        ...
        adModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
          AdModal,
          {
            bgId: adModal.bgId,
...
const PremiumTab = ({
  ...
  const remainingDays = premiumUntil ? Math.max(
    0,
    Math.ceil((premiumUntil - Date.now()) / (1e3 * 60 * 60 * 24))
  ) : 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 36, marginBottom: 4 }, children: "👑" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: "Enjoy uninterrupted gameplay!"
            }
          ),
          isPremiumActive && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                marginTop: 8,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: PREMIUM_PLANS.map((plan, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          PremiumCard,
          {
            plan,
...
const PremiumCard = ({
  ...
  {
    style: {
      background: plan.popular ? "linear-gradient(135deg, #FFE566 0%, #FF8C00 100%)" : "linear-gradient(135deg, #1e3a5f 0%, #2d5986 100%)",
      border: plan.popular ? "3px solid #FFD700" : "3px solid rgba(255,255,255,0.2)",
      borderRadius: 18,
      padding: "16px 12px",
      textAlign: "center",
      position: "relative",
      boxShadow: plan.popular ? "0 6px 0 rgba(0,0,0,0.25), 0 8px 24px rgba(255,200,0,0.3)" : "0 4px 0 rgba(0,0,0,0.3)"
    },
    "data-ocid": `shop.premium.item.${index2}`,
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          onClick: onBuy,
          style: {
            background: plan.popular ? "linear-gradient(135deg, #FF6B35, #FF4500)" : "linear-gradient(135deg, #4DE3FF, #0099CC)",
            border: "3px solid rgba(0,0,0,0.2)",
            borderRadius: 12,
            color: "white",
            fontFamily: "Fredoka One, Nunito, sans-serif",
          ...
          "data-ocid": `shop.premium.buy_button.${index2}`,
          children: "Buy Now"
        }
      )
    ]
...
const BackgroundsTab = ({
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: NORMAL_BACKGROUNDS.map((bg, idx) => {
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      style: {
        background: "linear-gradient(135deg, #1A0F00 0%, #4A2800 50%, #8B5000 100%)",
        border: "3px solid #FFD700",
        borderRadius: 16,
        padding: "12px 14px",
        marginBottom: 16,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: VIP_BACKGROUNDS.map((bg, idx) => {
              const isUnlocked = save.unlockedBackgrounds.includes(bg.id);
              const isActive = save.activeBackground === bg.gradient;
              const adsWatched = adCounts[bg.id] ?? 0;
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const BgCard = ({
  ...
  "div",
  {
    style: {
      background: "rgba(0,0,0,0.3)",
      border: isActive ? "3px solid #4CAF50" : isVip ? "2px solid rgba(255,215,0,0.4)" : "2px solid rgba(255,255,255,0.15)",
      borderRadius: 14,
      padding: "10px 8px",
      textAlign: "center",
      display: "flex",
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
            ...
            flexShrink: 0,
            boxShadow: isVip ? "0 0 12px rgba(255,215,0,0.4)" : void 0,
            position: "relative"
          },
          children: isVip && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                position: "absolute",
      ...
      isUnlocked ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          style: {
            background: isActive ? "linear-gradient(135deg, #4CAF50, #2ED573)" : "linear-gradient(135deg, #2196F3, #0077B6)",
            border: "2px solid rgba(0,0,0,0.2)",
            borderRadius: 8,
            color: "white",
            fontFamily: "Fredoka One, Nunito, sans-serif",
          ...
          disabled: isActive,
          "data-ocid": `shop.bg.select_button.${index2}`,
          children: isActive ? "✓ Active" : "Use"
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            isVip && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                "data-ocid": `shop.bg.buy_button.${index2}`,
                children: "₹29"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                "data-ocid": `shop.bg.watch_ad_button.${index2}`,
                children: [
                  "📺 (",
                  adsWatched,
                  "/",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      style: {
        position: "fixed",
        inset: 0,
        background: "linear-gradient(135deg, #1a0533 0%, #3b0f6b 40%, #1a0533 100%)",
        display: "flex",
        flexDirection: "column",
        alignItems: "center",
        justifyContent: "center",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
              inset: 0,
              background: "radial-gradient(ellipse at 50% 50%, rgba(180,80,255,0.25) 0%, transparent 70%)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              textAlign: "center",
              transform: phase === "show" ? "translateY(0) scale(1)" : "translateY(40px) scale(0.85)",
              opacity: phase === "show" ? 1 : 0,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    fontFamily: "Fredoka One, Nunito, sans-serif",
                    lineHeight: 1,
                    background: "linear-gradient(135deg, #FFE000 0%, #FF8C00 60%, #FF4FD8 100%)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text",
                    filter: "drop-shadow(-3px -3px 0 rgba(0,0,0,0.6)) drop-shadow(3px -3px 0 rgba(0,0,0,0.6)) drop-shadow(-3px 3px 0 rgba(0,0,0,0.6)) drop-shadow(3px 3px 0 rgba(0,0,0,0.6)) drop-shadow(0 8px 0 rgba(0,0,0,0.3))",
                    letterSpacing: "2px"
                  },
                  children: "SortCraft"
                }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: [
                    ...
                    "#FF6BC1",
                    "#9B59B6"
                  ].map((color, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        width: 16,
...
const App = () => {
  const [save, setSave] = reactExports.useState(() => loadSave());
  const [screen, setScreen] = reactExports.useState({ type: "welcome" });
  const [soundEnabled, setSoundEnabled] = reactExports.useState(
    () => loadSave().soundEnabled
  );
  const [musicEnabled, setMusicEnabled] = reactExports.useState(
    () => loadSave().musicEnabled
  );
  reactExports.useEffect(() => {
    saveSave(save);
  }, [save]);
  const handleToggleSound = reactExports.useCallback(() => {
    const newVal = soundSystem.toggleSound();
    setSoundEnabled(newVal);
    setSave((prev) => ({ ...prev, soundEnabled: newVal }));
  }, []);
  const handleToggleMusic = reactExports.useCallback(() => {
  ...
  const handleLevelSelect = reactExports.useCallback(() => {
    setScreen({ type: "levelSelect" });
  }, []);
  const handleDailyChallenge = reactExports.useCallback(() => {
    const tubes = generateDailyChallenge(/* @__PURE__ */ new Date());
    setScreen({ type: "game", levelNum: 0, isDaily: true, dailyTubes: tubes });
  }, []);
  const handleSelectLevel = reactExports.useCallback((levelNum) => {
    setScreen({ type: "game", levelNum });
  }, []);
  const handleOpenShop = reactExports.useCallback(() => {
    setScreen({ type: "shop" });
  }, []);
  const handleLevelComplete = reactExports.useCallback(
    (levelNum, stars, moves, isDaily = false) => {
      if (isDaily) {
        setSave((prev) => {
  ...
  const handleLevelFailed = reactExports.useCallback(
    (levelNum, hintsLeft) => {
      setScreen({ type: "levelFailed", levelNum, hintsLeft });
    },
    []
  );
  const handleNextLevel = reactExports.useCallback((currentLevel) => {
  ...
  const handleReplay = reactExports.useCallback((levelNum, isDaily = false) => {
    if (isDaily) {
      const tubes = generateDailyChallenge(/* @__PURE__ */ new Date());
      setScreen({
        type: "game",
  ...
  const handleQuitToMap = reactExports.useCallback(() => {
    setScreen({ type: "levelSelect" });
  }, []);
  const handleQuitToHome = reactExports.useCallback(() => {
    setScreen({ type: "home" });
  }, []);
  const renderScreen = () => {
    switch (screen.type) {
      case "welcome":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(WelcomeScreen, { onDone: () => setScreen({ type: "home" }) });
      case "home":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          HomeScreen,
          {
      ...
      case "loading":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          LoadingScreen,
          {
            onComplete: () => setScreen({ type: "game", levelNum: screen.nextLevel })
          }
        );
      case "levelSelect":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      case "game":
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "relative" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          GameScreen,
          {
            ...
            save,
            onLevelComplete: (lvl, stars, moves) => handleLevelComplete(lvl, stars, moves, screen.isDaily),
          ...
          `game-${screen.levelNum}-${screen.isDaily ? "daily" : "normal"}`
        ) });
      case "levelComplete":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          LevelCompleteScreen,
      ...
      case "levelFailed":
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            `failed-${screen.levelNum}`
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            LevelFailedScreen,
            {
              onRetry: () => setScreen({ type: "game", levelNum: screen.levelNum }),
              onUseHint: () => setScreen({ type: "game", levelNum: screen.levelNum }),
              onQuitToMap: handleQuitToMap,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "app-root", children: renderScreen() });
};
